...
escalate_feedback_template = ChatPromptTemplate.from_messages(
    [
        ...
        (
            "human",
            "Generate a request to escalate this  feedback to a human agent: {feedback}."
        ),
    ]
)
...
branches = RunnableBranch(
    ...
    (lambda x : "negative" in x, negative_feedback_template | model | StrOutputParser() # Negative feedback chain
    ),
    (lambda x : "neutral" in x, neutral_feedback_template | model | StrOutputParser() # Neutral feedback chain
    ),
    escalate_feedback_template |  model | StrOutputParser()
)

# Create the classificaiton chain
classification_chain = classification_template |  model | StrOutputParser()

# Combine classificaiton and response generation into one chain
...
# Output the results
for review, response in results.items():
