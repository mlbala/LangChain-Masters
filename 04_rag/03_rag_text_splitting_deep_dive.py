...
# funciton to create and persist vector store
...
# Useful for consistent chunk sizes regardless of content structures.
...
class CustomTextSplitter(TextSplitter):
    def split_text(self, text):
        ...
        for paragraph in paragraphs:
            # Further split by bullet points or custom markers
            split_lines.extend(paragraph.split("\n- "))
